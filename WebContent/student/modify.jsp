		...
		<div class="col-md-12">
			...
			<div class="box box-primary">
				...
				<form role="form" method="post" class="form-horizontal"
					action="/student?command=stud_modify">
					...
					<div class="form-group input-short">
						...
						<div class="col-sm-10">
							...
							<%-- name="compnum" class="form-control" onchange="compSelect(this.value)">
                           <c:forEach var="list" items="${list}">
							...
							</select> <span id="validateCompanyMessage"></span>
						</div>
					</div>
					<%-- <div class="form-group input-short">
                     <label for="exampleInputEmail1" class="col-sm-2 control-label">
                  ...
                  <div class="form-group input-short">
					...
					<div class="box-footer btn-group-center">
						...
						<button type="submit" class="btn btn-primary" id="submitbutton"
							onclick="return validateEmptyVal()">수정</button>
...
$(document).ready(function() {
	...
	$(".btn-warning").on("click", function() {
		formObj.attr("action", "student?command=stud_modify");
