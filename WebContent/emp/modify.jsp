				...
				<form role="form" method="post" onsubmit="return validateEmptyVal()" class="form-horizontal">
					<div class="box-body box-form-custom">
						<div class="form-group input-short">
							...
							<div class="col-sm-10">
								<input type="text" name='empname' class="form-control" value="${employeeVO.empname}" placeholder="ex) 홍길동">
							</div>
						</div>
						<div class="form-group input-short">
							<label for="exampleInputEmail1" class="col-sm-2 control-label">
							...
							<div class="col-sm-10">
								<input type="text" name='position' class="form-control" value="${employeeVO.position}" placeholder="ex) 강사">
							</div>
						</div>
						<div class="form-group input-short">
							<label for="exampleInputEmail1" class="col-sm-2 control-label">
							...
							<div class="col-sm-10">
								<input type="text" name='empemail' class="form-control" value="${employeeVO.empemail}" placeholder="ex) sample01@samp.le">
							</div>
						</div>
						<div class="form-group input-short"> 
							<label for="exampleInputEmail1" class="col-sm-2 control-label">
							...
							<div class="col-sm-10">
								<input type="text" id="cellPhone" name='empphone' class="form-control"
								maxlength="13" value="${employeeVO.empphone}" placeholder="ex) 01011112222">
							</div>
						</div>
						<div class="form-group input-short">
							<label for="exampleInputEmail1" class="col-sm-2 control-label">
							...
							<div class="col-sm-10">
								<select class="form-control" name="compnum">
									<c:forEach items="${compList}" var="comp" varStatus="status">
										<c:choose>
											<c:when test="${comp.compNum eq employeeVO.compnum}">
						...
						<div class="form-group input-short">
							...
							<div class="col-sm-10">
								<div class="input-group">
									...
									<input type="text" name='snslink1' class="form-control" value="${employeeVO.snslink1}" aria-describedby="basic-addon1" placeholder="ex) johnDoe">
								</div>
							</div>
						</div>
						<div class="form-group input-short">
							...
							<div class="col-sm-10">
								<div class="input-group">
									...
									<input type="text" name='snslink2' class="form-control" value="${employeeVO.snslink2}" aria-describedby="basic-addon1" placeholder="ex) johnDoe">
								</div>
							</div>
						</div>
						<div class="form-group input-short">
							...
							<div class="col-sm-10">
								<div class="input-group">
									...
									<input type="text" name='snslink3' class="form-control" value="${employeeVO.snslink3}" aria-describedby="basic-addon1" placeholder="ex) johnDoe">
								</div>
							</div>
						</div>
						<div class="form-group input-short">
							...
							<div class="col-sm-10">
								<textarea rows="5" name='empdesc' class="form-control"  placeholder="긴 내용 입력용">${employeeVO.empdesc}</textarea>
							</div>
						</div>
						<div class="form-group input-long">
							<label for="exampleInputEmail1" class="col-sm-2 control-label">직원 사진</label> 
							<div class="col-sm-10 form-upload-custom filebox">
							<div class="fileDrop">
...
$(document).ready(function(){
	...
	$(".btn-remove").on("click", function(){
		  self.location = "/admin/emp/remove?empnum=${employeeVO.empnum}";
	});
...
var empnum = ${employeeVO.empnum};
var template = Handlebars.compile($("#template").html());

$.getJSON("/admin/emp/getAttach/"+empnum, function(list){
	$(list).each(function(){
