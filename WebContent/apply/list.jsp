...
<!-- 									</td> -->
									<td style="text-align: center;">${applyVO.appnum}</td>
									<td style="text-align: center;"><a
										href='/admin/apply/modify${pageMaker.makeAppSearch(pageMaker.cri.page) }&appnum=${applyVO.appnum}'>
											${applyVO.courname} </a></td>
									 <td style="text-align: center;">${applyVO.stuname}</td>
									<td style="text-align: center;">${applyVO.compname}</td>
									<td style="text-align: center;">
										<fmt:formatDate value="${applyVO.sdate}" pattern="yyyy년 M월 d일" /> 
										&nbsp; ~ &nbsp;
										<fmt:formatDate value="${applyVO.edate}" pattern="yyyy년 M월 d일" /> 
									</td>
									<td style="text-align: center;">${applyVO.dayinfo} </td>
									<td style="text-align: right;">${applyVO.price}원</td>
								</tr>
					...
					<div class="box-footer">
						...
						<!-- .text-center END -->
						<div class="btn-group-custom">
							<a type="button" href="/admin/apply/register"
