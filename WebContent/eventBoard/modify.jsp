        ...
        <div class="col-md-12">
            ...
            <div class="box box-primary">
                ...
                <form role="form" name="fileForm" method="post" class="form-horizontal" enctype="multipart/form-data">
                    <input type="hidden" name='num' value="${eventBoardVO.num}">
                    ...
                    <div class="box-body box-form-custom">
                        <div class="form-group input-long">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name='title' id="title" class="form-control" value="${eventBoardVO.title}" placeholder="제목...">
                            </div>
                        </div>
                        <div class="form-group input-long">
                            <label for="" class="col-sm-2 control-label">내용</label>
                            <div class="col-sm-10">
                                <textarea rows="5" name="content" class="form-control" placeholder="내용...">${eventBoardVO.content}</textarea>
                            </div>
                        </div>
                        <div class="form-group input-long">
                            <label for="applylink" class="col-sm-2 control-label">신청 링크</label>
                            <div class="col-sm-10">
                                <input type="text" name='applylink' class="form-control" value="${eventBoardVO.applylink}" placeholder="신청링크...">
                            </div>
                        </div>
                        <div class="form-group input-long">
                            <label for="paylink" class="col-sm-2 control-label">결제 링크</label>
                            <div class="col-sm-10">
                                <input type="text" name='paylink' class="form-control" value="${eventBoardVO.paylink}" placeholder="결제링크...">
                            </div>
                        </div>
                        <div class="form-group input-long">
                            ...
                            <div class="filebox preview-image">
                                <div class="col-sm-10">
                                    <c:if test="${imgFile.name ne null}">
                                        <div class="upload-display">
                                            <div class="upload-thumb-wrap">
                                                <img src="displayImg?fileName=${imgFile.name}" class="upload-thumb">
                                            </div>
                                        </div>
                                    </c:if>
                                    ...
                                    <!-- 사진 사이즈는 1MB ~ 5MB까지 -->
                                    <input type="text" class="upload-name" value="${imgFile.name}" placeholder="파일선택" readonly="readonly" name="imgName" id="imgValue">
                        ...
                        <div class="form-group input-long">
                            ...
                            <div class="attachFilebox">
                                <div class="col-sm-10">
                                    ...
                                    <!-- 사진 사이즈는 1MB ~ 5MB까지 -->
                                    <input type="text" class="attach-upload-name" value="${attachFile.name}" placeholder="파일선택" readonly="readonly" name="attachName">
                                    ...
                                    <button type="button" id="deleteFile" style="display: none">삭제</button><br>
                                    <a href="downloadFile.do?fileName=${attachFile.name}">${attachFile.name}</a>
                                </div>
                            </div>
                        </div>
